...
First, classify yourself with [`roles.md`](~/.agents/plugins/interaction/references/roles.md), and load the `theory-of-mind` skill once. This skill is the upward projection of that theory: re-ground the reader, carry the delta, compress to what they need.
