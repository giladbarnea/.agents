...
**Tips:**
1. Since teammates talk to each other, tell each of them to load [`roles.md`](../../../references/roles.md) and the skills it routes to (for a teammate: `ai-to-leader` plus [`peers.md`](peers.md)) on top of the context-gathering skills. If you are spawning an adversary among them, tell it to load the `peer-review` skill too.
    <team-example>
