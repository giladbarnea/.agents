...
> Note: this section applies only to AI’s that do not mechanically inherit the session’s context window. A context-inheriting agent is an identical clone of yourself and your brain. No need to give it context because it already knows 100% of what you know. Just tell it what to go for. 
