---
name: impeccable-style-ux
description: Universal UX fundamentals — clear UX copy (labels, error messages, microcopy, empty states) and production hardening (edge cases, error/loading states, onboarding, i18n, accessibility resilience).
---


Improve the user experience of an interface using the universal UX building blocks shared by every good product: clear communication and resilience under real-world conditions.

**How to use this file:**
- **Clarify**: Apply when the problem is communication — confusing labels, unhelpful errors, unclear instructions, dead-end states.
- **Harden**: Apply when the problem is robustness — edge cases, error/loading/empty states, onboarding, i18n, accessibility.

Follow the **Foundations** section of `references/ui.md` — including the Context Gathering Protocol — before proceeding.
...
Follow the **Foundations** section of `references/ui.md` — including the Context Gathering Protocol — before proceeding. Additionally gather: audience technical level and users' mental state in context.
